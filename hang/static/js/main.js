...
$.ajax({url: "/product-list", success: function(response){
...
function renderProducts(){
    let product_disp = document.getElementById('Product');
		let product_overview = document.getElementById('overlay');
		...
		//Listing the available products
			...
			product_disp.innerHTML+=
			`
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${product[i].category}">
			<!-- Block2 -->
			<div class="block2">
				<div class="block2-pic hov-img0">
					<img src="../static/images/${product[i].id}.jpg" alt="IMG-PRODUCT">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="../static/images/${product[i].id}.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="../static/images/${product[i].id}.jpg" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../static/images/${product[i].id}.jpg">
								...
								<div class="item-slick3" data-thumb="../static/images/${product[i].id}.jpg">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../static/images/${product[i].tag}.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="time" id="size">
											...
											<option>Size ${product[i].size[0]}</option>
											<option>Size ${product[i].size[1]}</option>
											<option>Size ${product[i].size[2]}</option>
											<option>Size ${product[i].size[3]}</option>
										</select>
